    ...
    <div className="flex items-center gap-2">
      ...
      {autoRefresh && (
        <select
          ...
          className="h-9 px-3 rounded-lg bg-white/10 dark:bg-white/5 border border-white/20 dark:border-white/10 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-primary"
        >
